...
export const adminApi = {
  ...
  createGroup: (payload) => api.post('/api/admin/groups', payload),
  updateGroup: (groupId, payload) => api.put(`/api/admin/groups/${groupId}`, payload),
  deleteGroup: (groupId) => api.delete(`/api/admin/groups/${groupId}`),
